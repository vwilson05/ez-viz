...
(() => {
var exports = {};
exports.id = "app/api/snowflake/schema/tables/route";
exports.ids = ["app/api/snowflake/schema/tables/route"];
exports.modules = {

/***/ "(rsc)/./app/api/snowflake/schema/tables/route.ts":
/*!**************************************************!*\
  !*** ./app/api/snowflake/schema/tables/route.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _app_lib_snowflake__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/app/lib/snowflake */ \"(rsc)/./app/lib/snowflake.ts\");\n\n\nasync function POST(req) {\n    try {\n        console.log('Received tables request');\n        let body;\n        try {\n            body = await req.json();\n        } catch (error) {\n            console.error('Failed to parse request body:', error);\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: 'Invalid JSON in request body'\n            }, {\n                status: 400\n            });\n        }\n        console.log('Request body:', {\n            account: body?.account,\n            username: body?.username,\n            hasPassword: !!body?.password,\n            warehouse: body?.warehouse,\n            database: body?.database,\n            schema: body?.schema,\n            role: body?.role\n        });\n        if (!body) {\n            console.log('No body provided');\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: 'Connection information is required'\n            }, {\n                status: 400\n            });\n        }\n        const { account, username, password, warehouse, database, schema } = body;\n        if (!schema) {\n            console.log('Missing schema parameter');\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: 'Schema is required'\n            }, {\n                status: 400\n            });\n        }\n        if (!account || !username || !password || !warehouse || !database) {\n            console.log('Missing required connection parameters');\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: 'Missing required connection parameters'\n            }, {\n                status: 400\n            });\n        }\n        // Establish connection\n        console.log('Attempting to establish connection to Snowflake');\n        const conn = await (0,_app_lib_snowflake__WEBPACK_IMPORTED_MODULE_1__.getConnection)({\n            account,\n            username,\n            password,\n            warehouse,\n            database,\n            schema: schema || 'PUBLIC',\n            role: body.role\n        });\n        console.log('Connection established successfully');\n        // Get tables for the specified schema\n        console.log(`Fetching tables for schema: ${schema}`);\n        const tables = await (0,_app_lib_snowflake__WEBPACK_IMPORTED_MODULE_1__.getTablesForSchema)(conn, schema);\n        console.log(`Found ${tables.length} tables in schema ${schema}`);\n        // Return response\n        console.log('Returning tables response');\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json(tables);\n    } catch (error) {\n        console.error('Error fetching tables:', error);\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: error.message || 'Failed to fetch tables'\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/snowflake/schema/tables/route.ts\n");
...
/***/ "(rsc)/./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Fsnowflake%2Fschema%2Ftables%2Froute&page=%2Fapi%2Fsnowflake%2Fschema%2Ftables%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Fsnowflake%2Fschema%2Ftables%2Froute.ts&appDir=%2FUsers%2Fvictorwilson%2FDesktop%2Fprojects%2FEZViz%2Fapp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=%2FUsers%2Fvictorwilson%2FDesktop%2Fprojects%2FEZViz&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   patchFetch: () => (/* binding */ patchFetch),\n/* harmony export */   routeModule: () => (/* binding */ routeModule),\n/* harmony export */   serverHooks: () => (/* binding */ serverHooks),\n/* harmony export */   workAsyncStorage: () => (/* binding */ workAsyncStorage),\n/* harmony export */   workUnitAsyncStorage: () => (/* binding */ workUnitAsyncStorage)\n/* harmony export */ });\n/* harmony import */ var next_dist_server_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/dist/server/route-modules/app-route/module.compiled */ \"(rsc)/./node_modules/next/dist/server/route-modules/app-route/module.compiled.js\");\n/* harmony import */ var next_dist_server_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! next/dist/server/route-kind */ \"(rsc)/./node_modules/next/dist/server/route-kind.js\");\n/* harmony import */ var next_dist_server_lib_patch_fetch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! next/dist/server/lib/patch-fetch */ \"(rsc)/./node_modules/next/dist/server/lib/patch-fetch.js\");\n/* harmony import */ var next_dist_server_lib_patch_fetch__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_lib_patch_fetch__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _Users_victorwilson_Desktop_projects_EZViz_app_api_snowflake_schema_tables_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/snowflake/schema/tables/route.ts */ \"(rsc)/./app/api/snowflake/schema/tables/route.ts\");\n\n\n\n\n// We inject the nextConfigOutput here so that we can use them in the route\n// module.\nconst nextConfigOutput = \"\"\nconst routeModule = new next_dist_server_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({\n    definition: {\n        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.APP_ROUTE,\n        page: \"/api/snowflake/schema/tables/route\",\n        pathname: \"/api/snowflake/schema/tables\",\n        filename: \"route\",\n        bundlePath: \"app/api/snowflake/schema/tables/route\"\n    },\n    resolvedPagePath: \"/Users/victorwilson/Desktop/projects/EZViz/app/api/snowflake/schema/tables/route.ts\",\n    nextConfigOutput,\n    userland: _Users_victorwilson_Desktop_projects_EZViz_app_api_snowflake_schema_tables_route_ts__WEBPACK_IMPORTED_MODULE_3__\n});\n// Pull out the exports that we need to expose from the module. This should\n// be eliminated when we've moved the other routes to the new format. These\n// are used to hook into the route.\nconst { workAsyncStorage, workUnitAsyncStorage, serverHooks } = routeModule;\nfunction patchFetch() {\n    return (0,next_dist_server_lib_patch_fetch__WEBPACK_IMPORTED_MODULE_2__.patchFetch)({\n        workAsyncStorage,\n        workUnitAsyncStorage\n    });\n}\n\n\n//# sourceMappingURL=app-route.js.map//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Fsnowflake%2Fschema%2Ftables%2Froute&page=%2Fapi%2Fsnowflake%2Fschema%2Ftables%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Fsnowflake%2Fschema%2Ftables%2Froute.ts&appDir=%2FUsers%2Fvictorwilson%2FDesktop%2Fprojects%2FEZViz%2Fapp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=%2FUsers%2Fvictorwilson%2FDesktop%2Fprojects%2FEZViz&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!\n");
